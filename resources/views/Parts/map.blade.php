...
<scrip src="{{ asset('js/clustermarkersVAR.js') }}">
    </script>
    <script>

        //Desactivamos los selects de municipio y provincia
        $("#provincia").prop("disabled", true);
        $("#municipio").prop("disabled", true);

        //Cuando se modifica el contenido del selector de comunidad autonoma, se buscan las provincias de esa comunidad
        //y se añaden en el selector de provincias, acto seguido se activa el selector para su uso
        ...
        //procedimiento similar al anterior pero con las provincias-Municipios
        ...
        //PRINCIPALES ICONOS DE LAS GRANDES ESTACIONES DE SERVICIO EN ESPAÑA
        //SE TIENE QUE HACER 1 POR 1 YA QUE LEAFLET NO PROPOCIONA UN MECANISMO AUTOMATIZADO PARA REALIZAR ESTO.

        var AGLA = new L.icon({
            iconUrl: '{{ asset("icons/AGLA.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var ALCAMPO = new L.icon({
            iconUrl: '{{ asset("icons/ALCAMPO.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var AVANZAOIL = new L.icon({
            iconUrl: '{{ asset("icons/AVANZAOIL.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var AVIA = new L.icon({
            iconUrl: '{{ asset("icons/AVIA.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var BALLENOIL = new L.icon({
            iconUrl: '{{ asset("icons/BALLENOIL.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var BONAREA = new L.icon({
            iconUrl: '{{ asset("icons/BONAREA.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var BP = new L.icon({
            iconUrl: '{{ asset("icons/BP.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var CAMPSA = new L.icon({
            iconUrl: '{{ asset("icons/CAMPSA.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var CARREFOUR = new L.icon({
            iconUrl: '{{ asset("icons/CARREFOUR.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var CEPSA = new L.icon({
            iconUrl: '{{ asset("icons/CEPSA.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var DISA = new L.icon({
            iconUrl: '{{ asset("icons/DISA.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var EROSKI = new L.icon({
            iconUrl: '{{ asset("icons/EROSKI.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var ESCLATOIL = new L.icon({
            iconUrl: '{{ asset("icons/ESCLATOIL.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var GALP = new L.icon({
            iconUrl: '{{ asset("icons/GALP.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var GASEXPRESS = new L.icon({
            iconUrl: '{{ asset("icons/GASEXPRESS.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var IBERDOEX = new L.icon({
            iconUrl: '{{ asset("icons/IBERDOEX.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var MEROIL = new L.icon({
            iconUrl: '{{ asset("icons/MEROIL.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var NATURGY = new L.icon({
            iconUrl: '{{ asset("icons/NATURGY.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var OTROS = new L.icon({
            iconUrl: '{{ asset("icons/OTROS.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var PETREM = new L.icon({
            iconUrl: '{{ asset("icons/PETREM.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var PETRONOR = new L.icon({
            iconUrl: '{{ asset("icons/PETRONOR.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var PETROPRIX = new L.icon({
            iconUrl: '{{ asset("icons/PETROPRIX.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var PLENOIL = new L.icon({
            iconUrl: '{{ asset("icons/PLENOIL.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var Q8 = new L.icon({
            iconUrl: '{{ asset("icons/Q8.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var REPSOL = new L.icon({
            iconUrl: '{{ asset("icons/REPSOL.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var SHELL = new L.icon({
            iconUrl: '{{ asset("icons/SHELL.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var TAMOIL = new L.icon({
            iconUrl: '{{ asset("icons/TAMOIL.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        var VALCARCE = new L.icon({
            iconUrl: '{{ asset("icons/VALCARCE.png") }}',
            iconSize: [50, 50],
            iconAnchor: [25, 51],
            popupAnchor: [0, -49],
        });
        ...
        //Creamos mapa y lo centramos en madrid.
        ...
        //Creamos un array el cual, en su interior tendra 52 clusters de marcadores, uno para cada provincia
        var arrayClusters = new Array(52);

        for (var i = 0; i < arrayClusters.length; i++) {
            arrayClusters[i] = new L.MarkerClusterGroup({
                disableClusteringAtZoom: 15
            });
        }

        //obtenemos todos los datos de las gasolineras y los mostramos por pantalla al cargar la pagina
        axios.get('{{ route('api.gasolineras.index') }}')
            .then(function (response) {
                //para ello recorremos todas las gasolieneras y utilizamos su id de provincia como indice
                //en el cual sera añadido en el array de marcadores.
        ...
        //Esta funcion se llama al hacer click en el boton filtrar
        function filtrar() {

            //Guardamos en variables los datos introducidos en los formularios con DOM
            ...
            //Modificamos las clases de los elementos por pantalla para dejar espacio para la tabla
            ...
            //En esta peticion pasamos los parametros por url y nos devuelve las gasolineras que coincidan
            axios.get("/api/filtro?comarca=" + comarca + "&provincia=" + provincia + "&municipio=" + municipio + "&gasolina=" + gasolina)
                .then(function(response) {
                    for (var i = 0; i < response.data.features.length; i++) {
                        ...
                        if (i < 10) {
                            if (i == 0) {
                                //utilizamos el primer resultado para centrar el mapa y mostrar la fecha de actualizacion
                            ...
                            //Añadimos en la tabla los 10 primeros resultados
                        ...
                        //Aqui tratamos los datos y creamos el marcador
                        var procesado = parseInt(response.data.features[i].properties.IDProvincia) - 1;
                        var iconomarca = crearmarker(response.data.features[i].properties.Rotulo);
                        ...
                        this.arrayClusters[procesado].addLayer(new L.marker([parseFloat(response.data.features[i].properties.Latitud), parseFloat(response.data.features[i].properties.Longitud)], {
                            icon: iconomarca
                        }).bindPopup("<h2 class='text-center'>Información</h2><table id='tablePreview' class='table table-sm table-bordered table-striped table-hover'> <tbody> <tr> <td><strong>Nombre</strong></td> <td>" + response.data.features[i].properties.Rotulo + "</td> </tr><tr> <td><strong>CP</strong></td> <td>" + response.data.features[i].properties.CP + "</td> </tr> <tr> <td><strong>Direccion</strong></td> <td>" + response.data.features[i].properties.Direccion + "</td> </tr> <tr> <td><strong>Horario</strong></td> <td>" + response.data.features[i].properties.Horario + "</td> </tr> <tr> <td><strong>" + gasolina + "</strong></td> <td>" + response.data.features[i].properties[gasolina] + "</td> </tr> </tbody> </table>"));
                    };
                })
                .catch(function(error) {
                    console.log(error);
        ...
        //Funcion para centrar la gasolinera con un zoom de 15
        function CentrarGasolinera(x, y) {
            map.flyTo([x, y], 15)
        }

        //Funcion para centrar el cluster en funcion de rango de busqueda
        ...
        //funcion para limpiar los layers
        ...
        //funcion para asignar el icono en funcion de el nombre de la estacion de servicio
        ...
        //Recorremos todos los clusters y los añadimos al mapa
        for (var i = 0; i < arrayClusters.length; i++) {
